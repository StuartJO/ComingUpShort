...
switch TractData
    case 'iFOD2'
data = load('.\data\EmpiricalSimilarity\Schaefer_7net_iFOD2_acpc_lh_str70Thr_fitMetrics.mat');
    case 'FACT'
data = load('.\data\EmpiricalSimilarity\Schaefer_7net_FACT_acpc_lh_str70Thr_fitMetrics.mat');
end
else
data = TractData;
end
