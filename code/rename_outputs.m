% The data was originally saved in a format which was a slight hassle to
% work with. I fixed it so it is easier for me
...
Output = load(['C:\Users\Stuart\Documents\GitHub\ComingUpShort\outputs\old\Hansen_Timing_0_RandMdl',num2str(mdl),'_',addmult,'_',expo,'.mat']);

FitMetricsOutput = load(['C:\Users\Stuart\Documents\GitHub\ComingUpShort\outputs\old\Hansen_Timing_0_RandMdl',num2str(mdl),'_',addmult,'_',expo,'_TopoTypes.mat']); 
...
Output = load(['C:\Users\Stuart\Documents\GitHub\ComingUpShort\outputs\old\Hansen_Timing_0_TopoMdl_',num2str(mdl),'_',addmult,'_',expo,'.mat']);

FitMetricsOutput = load(['C:\Users\Stuart\Documents\GitHub\ComingUpShort\outputs\old\Hansen_Timing_0_TopoMdl_',num2str(mdl),'_',addmult,'_',expo,'_TopoTypes.mat']); 
...
save(['./outputs/GNM_TopoMdl',num2str(mdl),'_',addmult,'_',expo,'.mat'],'-struct','MdlOutput','-v7.3')
