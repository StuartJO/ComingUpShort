load('C:\Users\Stuart\Documents\GitHub\ComingUpShort\data\Hansen_networks_WB.mat')
...
Output = load(['C:\Users\Stuart\Documents\GitHub\ComingUpShort\outputs\old\WB_Hansen_Timing_0_Mdl',num2str(mdl),'_',addmult,'_',expo,'.mat']);
...
save(['./outputs/WB_GNM_Mdl',num2str(mdl),'_',addmult,'_',expo,'.mat'],'-struct','MdlOutput','-v7.3')
