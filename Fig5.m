...
colors = [0, 20, 39; 244, 213, 141;141, 8, 1]./255;
...
DegCorr{j} = mean(TopoMeasures{j}.TopogCorr(:,:,1));
...
for j = 1:3
    plot(1-EdgeOvlp,DegCorr{j},'Color',colors(j,:),'LineWidth',2)
    hold on
end
%set(gca,'XDir','reverse')
xlabel('Proportion of connections rewired')
...
AddLetters2Plots(ax1, 'HShift', -0.1, 'VShift', -0.05,'FontSize',18)
